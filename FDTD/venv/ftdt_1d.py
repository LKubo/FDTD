...
print("Coeficiente de refração teórico: {}".format((n2-1)/(n2+1)))
# Plotagem da onda
plt.ion()
fig = plt.figure()
...
for te in range(1, T2, 8):
     plt.clf()
     plt.scatter(315, 0, s=10, c='red')
     plt.scatter(615, 0, s=10, c='red')
     plt.scatter(1315, 0, s=10, c='red')
     plt.scatter(1615, 0, s=10, c='red')
